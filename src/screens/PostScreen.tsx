...
export default function PostScreen({ navigation }: any) {
  ...
  async function pickImage() {
    ...
    if (status !== 'granted') {
      Alert.alert('Permission needed', 'We need access to your photos to post an outfit.');
      return;
    }
      ...
      {imageUri ? (
        <>
          ...
          <ScrollView style={styles.form}>
            ...
            <Text style={styles.sectionLabel}>Tag pieces from your closet</Text>
            <Text style={styles.sectionSub}>Tap pieces that you're wearing in this photo</Text>
          </ScrollView>
        </>
      ) : (
